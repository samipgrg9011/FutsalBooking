        ...
        <div className="md:w-3/5 p-8 flex flex-col justify-between min-h-[300px]">
          ...
          <div className="mt-4">
            <button
              ...
              className="group inline-flex items-center px-5 py-2.5 bg-emerald-500 text-white rounded-lg hover:bg-indigo-700 transition-all duration-300 shadow-md hover:shadow-lg text-lg"
            >
              View Details
              <svg
